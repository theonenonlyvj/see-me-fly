...
const settings = (over: Partial<Settings>): Settings => ({
  groupAirports: false, explicitlyUnique: true, includeCanceled: false, excludeBeforeDate: null, home: null, layoverMaxHours: 5, splitCountriesByState: [], groupAircraftFamilies: false, duration: C, ...over,
})
