...
export const CARDS: CardDef[] = [
  ...
  whenYouFlyCard, bodyClockCard, whenYouFlyOverlayCard, dayOfWeekCard, redEyesCard, commuterCadenceCard, nightsAwayCard, tripsExplorerCard, intensityCard, yearBloomsCard,
